...
ASTNode *
create_declaration_node (DataType type, char *name, ASTNode *init,
...
ASTNode *
create_assignment_node (char *var, Operator op, ASTNode *value, uint64_t hash)
{
...
ASTNode *
create_expression_node (Operator op, ASTNode *left, ASTNode *right,
			char *value)
{
...
ASTNode *
create_condition_node (Operator op, ASTNode *left, ASTNode *right)
{
...
ASTNode *
create_if_node (ASTNode *condition, ASTNode *then_stmt, ASTNode *else_stmt)
{
...
ASTNode *
create_while_node (ASTNode *condition, ASTNode *body, uint64_t loop_hash)
{
...
ASTNode *
create_for_node (ASTNode *init, ASTNode *condition, ASTNode *increment,
		 ASTNode *body, uint64_t loop_hash)
{
...
ASTNode *
create_compound_node (ASTNode *statements)
{
...
ASTNode *
create_return_node (ASTNode *value)
{
...
ASTNode *
create_binary_op_node (Operator op, ASTNode *left, ASTNode *right)
{
...
ASTNode *
create_unary_op_node (Operator op, ASTNode *operand)
{
...
ASTNode *
create_function_call_node (char *name, ASTNode *arguments)
{
...
ASTNode *
create_parameter_list_node (ASTNode *parameters)
{
...
void
add_statement (ASTNode *program, ASTNode *statement)
{
...
ASTNode *
add_args (ASTNode *list, ASTNode *expr)
{
...
void
print_ast (ASTNode *node, int depth)
{
  if (node == NULL)
    return;
