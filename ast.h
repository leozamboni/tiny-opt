...
ASTNode *create_declaration_node (DataType type, char *name, ASTNode * init,
				  int array_size, uint64_t hash);
ASTNode *create_assignment_node (char *var, Operator op, ASTNode * value,
				 uint64_t hash);
ASTNode *create_expression_node (Operator op, ASTNode * left, ASTNode * right,
				 char *value);
ASTNode *create_condition_node (Operator op, ASTNode * left, ASTNode * right);
ASTNode *create_if_node (ASTNode * condition, ASTNode * then_stmt,
			 ASTNode * else_stmt);
...
ASTNode *create_function_def_node (DataType return_type, char *name,
